...
DEFAULT_TREND_PARAMS: dict = {
    "window": 20, "std_dev": 2.0, "atr_multiplier": 2.5,
    "max_hold_bars": 48, "adx_threshold": 25, "rsi_threshold": 30,
    "entry_zone": 1.0, "take_profit_pct": 0.05, "stop_loss_pct": 0.03,
}

DEFAULT_SCALP_PARAMS: dict = {
    "window": 10, "std_dev": 1.2, "take_profit_pct": 0.005,
    "stop_loss_pct": 0.003, "max_hold_bars": 6, "rsi_period": 14,
}

DEFAULT_HYBRID_MM_PARAMS: dict = {
    "rsi_period": 5, "rsi_low": 28, "rsi_high": 72,
    "ma_period": 25, "atr_period": 12, "atr_multiplier": 3.5,
    "max_hold_bars": 48, "take_profit_pct": 0.03, "stop_loss_pct": 0.02,
}

DEFAULT_PURE_ACTION_PARAMS: dict = {
    "window": 20, "std_dev": 2.0, "atr_period": 14, "atr_multiplier": 2.0,
    "max_hold_bars": 36, "entry_zone": 0.0, "enable_short": True,
}
